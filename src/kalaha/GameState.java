...
public class GameState 
{
    ...
    public boolean makeMove(int ambo)
    {
        ...
        {
            cMoveI = START_S + ambo;
            //System.out.println("I'm in south....make move");
        }
        else
        {
            cMoveI = START_N + ambo;
            //System.out.println("I'm in north....make move");
        }
    ...
    public boolean moveIsPossible(int ambo)
    {
        ...
        if (nextPlayer == 1)
        {
            ...
            System.out.println(" SOUTH PLAYER DOBINDHI");
        }
        else
        {
            if (board[START_N + ambo] > 0) return true;
            System.out.println(" NORTH PLAYER DOBINDHI");
        }
        System.out.println(" AMBOs LEV RA PULKA...CHUSI RAAYI CODE KONCHEM BURRA THAKUVA YEDHAVA");
        return false;
